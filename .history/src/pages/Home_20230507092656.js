  ...
  useEffect(() => {
    ...
    loader.load().then(() => {
      ...
      marker.addListener("click", () => {
        ...
        <Link to="/weatherdata" style={{color:'blue', textDecoration: 'underline'}}> View more stats</Link>
        `;
    ...
    marker1.addListener("click", () => {
      ...
      <h1> <b> Sensor Location: ${location}</b> </h1>
        ...
        <h2> Humidity: ${humidity}% </h2>
        <h2> Soil Moisture: ${soilMoisture}% </h2>
        <a href="https://localhost:3000/weatherdata" style="color:blue; text-decoration:underline;">View more stats</a>
      </div>
      `;
