            ...
            <Grid numCols={1} numColsSm={2} numColsLg={3} className="gap-2">
              <Col numColSpan={1} numColSpanLg={2}>
                <Card>
                  ...
                  <Divider />
                  <Subtitle> Crop Recommendations </Subtitle>
                  <Text>
                    {" "}
                  ...
                  <Text>
                    ...
                    20°C and 30°C. Moderate humidity levels typically ranging
                    from 50% to 80%.
                  </Text>
                  <Subtitle>Wheat</Subtitle>
                  <Text>
                    Conditions that are favourable for the growth of wheat
                    include the following:- <br/> Temperature that ranges between
                    15°C and 24°C. <br/> Relatively higher humidity levels typically
