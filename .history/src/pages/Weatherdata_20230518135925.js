            ...
            <Grid numCols={1} numColsSm={2} numColsLg={3} className="gap-2">
              <Col numColSpan={1} numColSpanLg={2}>
                <Card>
                  ...
                  <Text>
                    Here are the conditions that are favourable for the growth
                    of maize include the following:- Temperature that ranges
                    between 20°C and 30°C. Moderate humidity levels typically
                    ranging from 50% to 80%.
                  </Text>
                  <Subtitle>Wheat</Subtitle>
                  <Text>
                    Here are the conditions that are favourable for the growth
                    of wheat include the following:- <br /> - Temperature that
