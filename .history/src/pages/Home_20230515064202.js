...
const Home = () => {
  ...
  useEffect(() => {
    ...
    <a href="http://localhost:3000/sensorFive" style="color:blue; text-decoration:underline;">View more stats</a>
    `;
      ...
      <a href="http://localhost:3000/sensorSix" style="color:blue; text-decoration:underline;">View more stats</a>
      `;
      ...
      marker6.addListener("click", () => {
        ...
        <a href="http://localhost:3000/sensorSeven" style="color:blue; text-decoration:underline;">View more stats</a>
        `;
