...
export default function WeatherDataGrid1(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.post("apikey for ML", {
        ...
        //Monthly data
        const response2 = await axios.post("apikey for ML", {
        ...
        //Monthly data
        const response3 = await axios.post("apikey for ML", {
