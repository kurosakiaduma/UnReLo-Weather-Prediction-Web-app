...
export default function App() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The sensors that are being displayed are LoRaWAN sensors that can be able to record temperature, humidity of an area.",
    },
    {
      question:
        "What does each line chart represents on the sensor statistics page?",
      answer: "The various line charts represent the temperature and humidity values of the sensor's area",
    },
    {
