...
class Weather extends React.Component {
    render()
    {
        ...
        <div style={{ border: '1px ', paddingLeft: '100px',paddingTop: '50px', display: 'inline-block' }}>
        <WiDaySunnyOvercast size={300} color='#87CEEB'/>
         <div>
           <h1 style={{fontSize: '4rem', color:'white',  fontWeight: 'bold', paddingLeft: '100px'}}> 28&deg;C </h1>
