              ...
              <Col numColSpan={1} numColSpanLg={2}>
                <Card>
                  ...
                  <Text>
                    ...
                    include the following:- Temperature that ranges between 20°C
                    and 30°C. Moderate humidity levels typically ranging from
                    50% to 80%.
                  </Text>
                  <Subtitle>Wheat</Subtitle>
                  <Text>
                    Conditions that are favourable for the growth of wheat
                    include the following:- <br /> Temperature that ranges
                    between 15°C and 24°C. <br /> Relatively higher humidity
                    levels typically ranging from 60% to 70%.
                  </Text>
                  <Subtitle>Rice</Subtitle>
                  <Text>
                    Conditions that are favourable for the growth of maize
                    include the following:- - Temperature that ranges between
                    20°C and 35°C. - Rice being a semi-aquatic crop and requires
                    high humidity levels ranging from 70% to 90%.
                  </Text>
                </Card>
              </Col>
              <Col>
