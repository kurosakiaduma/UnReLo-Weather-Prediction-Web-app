        ...
        <>
          <Grid numColsLg={6} className="mt-6 gap-6">
            ...
            <Card className="max-w-lg">
              <Flex alignItems="start">
                <div>
                  <Text>Today</Text>
                  <img width="72px" height="72px" title="Feels Cloudy" src="https://www.flaticon.com/free-icons/sun"/>
                </div>
          ...
          <div className="mt-6">
            <Card>
              ...
              <Text>Five day prediction of weather patterns based on collected data</Text>
              <AreaChart 
               className="h-72 mt-4"
               data={chardata1}
               index="date"
