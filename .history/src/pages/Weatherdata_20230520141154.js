          ...
          <>
            <Grid numCols={1} numColsSm={2} numColsLg={3} className="gap-2">
              ...
              <Card>
                ...
                <Divider />
                <Text>There are other factors that are influenced by weather conditions, specifically temperature and humidity. Such as the prevalence of pests in Kenya:- </Text>
                <Title> Pests </Title>
              </Card>
            </Grid>
          </>
