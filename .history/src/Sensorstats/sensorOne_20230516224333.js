...
export default function SensorOne(props) {
  ...
  return (
    <main className="bg-slate-50 p-6 sm:p-10">
      <Title> Nairobi Sensor Statistics</Title>
      <Text>
      ...
      >
        ...
        <Tab value=""  text="Agricultural components"/>
        ...
        <>
            ...
            >
              ...
              >
                <Flex>
                  ...
                  <div>
                    <Text style={{ fontSize: "20px" }}>Temperature: 28 °C</Text>
          ...
          <div className="mt-6">
            <Card>
              ...
              <Text>Projected weather patterns for that area</Text>
              <AreaChart
                className="h-72 mt-4"
                data={chardata2}
                index="date"
